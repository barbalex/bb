...
export default React.createClass({
  ...
  render () {
    ...
    const eventsTableHeadTop = introJumbotronHeight ? introJumbotronHeight + 23 : 331
    ...
    return (
      <div className='events'>
        <Jumbotron ref={(j) => this.introJumbotron = j} className='eventsIntro'>
          ...
          <p>The pur&shy;pose of this web&shy;site is to gain an over&shy;view by chro&shy;no&shy;lo&shy;gi&shy;cal&shy;ly cove&shy;ring both <strong>ma&shy;ri&shy;ti&shy;me</strong> and <strong>po&shy;li&shy;ti&shy;cal</strong> events.</p>
