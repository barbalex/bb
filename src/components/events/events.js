    ...
    return (
      <div className='events'>
        <Jumbotron ref={(j) => this.introJumbotron = j} className='eventsIntro'>
          ...
          <p><strong>The pur&shy;pose of this web&shy;site is to gain an over&shy;view by chro&shy;no&shy;lo&shy;gi&shy;cal&shy;ly cove&shy;ring both ma&shy;ri&shy;ti&shy;me and poli&shy;ti&shy;cal events.</strong></p>
